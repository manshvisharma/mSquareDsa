...
export default function SheetView() {
  ...
  // 2. REACTIVE UPDATES (Sync Solved Status)
  useEffect(() => {
  ...
  const handleTopicChange = (tid: string) => {
      ...
      setSearchQuery(''); // Clear search on topic change if you want, or keep it global
  };
  ...
  const handleToggleProblem = async (problem: FullProblem) => {
    ...
    setTopics(prev => prev.map(t => {
        // Optimistic update across all topics (needed for search view)
    ...
    try {
        ...
        toggleProblem(user.uid, problem.id, newStatus).then(() => refreshProfile()); 
    } catch (e) {
  ...
  const filteredTopics = useMemo(() => {
      ...
      // If searching, show ALL matching problems across ALL topics
      return topics.map(t => {
    ...
    <div className="max-w-[1400px] mx-auto pb-12 px-2 lg:px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
            ...
            <div className="flex gap-4">
                <button 
                    ...
                    className="flex flex-col items-center justify-center bg-indigo-50 dark:bg-indigo-900/20 px-6 py-4 rounded-xl border-2 border-indigo-100 dark:border-indigo-800 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 transition-colors group"
                ...
                <div className="flex-shrink-0 bg-orange-50 dark:bg-gray-800 px-6 py-4 rounded-xl border-2 border-orange-100 dark:border-gray-700 flex flex-col items-center justify-center min-w-[100px]">
             ...
             <div key={topic.id} className="animate-in fade-in slide-in-from-bottom-2 duration-300 mb-10">
                 ...
                 <div className="space-y-8">
                    {topic.subPatterns.map(sp => {
                        ...
                        const isExpanded = searchQuery ? true : expandedSubPatterns.has(sp.id); // Auto-expand on search
                                ...
                                >
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div className="flex flex-col items-start">
                                            <span className={`font-bold text-2xl ${isComplete ? 'text-success-700 dark:text-success-400' : 'text-slate-900 dark:text-white'}`}>
                                                {sp.title}
                                            </span>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="w-32 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden hidden sm:block border border-gray-300 dark:border-gray-600">
                                            {/* Changed Progress Bar Color for Dark Mode to Violet */}
                                            <div 
                                            ...
                                            >
                                                <div className="flex items-start gap-5 flex-1 mb-4 md:mb-0">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        {/* Metadata Row: Increased Spacing (mt-3, gap-4) */}
                                                        <div className="flex items-center mt-3 gap-4 flex-wrap">
                                                            <div className="flex items-center gap-2 px-2 py-0.5 rounded-md border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-dark-surface text-xs font-bold text-slate-600 dark:text-slate-300">
      ...
      {isNoteModalOpen && currentNoteProb && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-dark-card w-full max-w-lg rounded-xl shadow-2xl overflow-hidden border border-gray-200 dark:border-dark-border">
                ...
                <div className="p-4 border-t border-gray-100 dark:border-dark-border flex justify-end gap-3 bg-gray-50 dark:bg-dark-surface">
                    ...
                    <button onClick={handleSaveNote} className="px-5 py-2 rounded-lg bg-primary-600 text-white hover:bg-primary-700 font-semibold flex items-center gap-2">
